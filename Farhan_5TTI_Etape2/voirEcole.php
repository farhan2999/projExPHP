...
<body>
    <header>
        <ul class="flexible space-evenly">
            ...
            <li  class="menu"><a href="../Users/inscriptionOrEditProfil.php">Inscription</a></li>
            <li  class="menu"><a href="../Users/connexion.php">Connexion</a></li>
            <!-- petit écran -->
            <li class="imageMenu"><a href="index.php"><ion-icon size="large" name="home-outline"></ion-icon></a></li>
            <li class="imageMenu"><a href="../Users/inscriptionOrEditProfil.php"><ion-icon size="large" name="person-outline"></ion-icon></a></li>
            <li class="imageMenu"> <a href="../Users/connexion.php"><ion-icon size="large" name="enter-outline"></ion-icon></a></li>
        </ul>
    </header>
    <main>
